    ...
    <div className="font-serif">
      ...
      <div className="px-6 py-4 space-y-4 ">
        <div className="h-fit w-full bg-pinkLite rounded-md py-4 pl-4">
          ...
          <ul className="list-disc marker:text-dippink pl-5 space-y-1 text-gray">
            <li>
              <span className="font-bold text-gray">Total</span>: Approximately
              10 minutes
            </li>
            <li>
      ...
      <div className="px-6 py-4 space-y-4 ">
        ...
        <ul className="list-decimal marker:text-Amber pl-5 border-b border-gray pb-5 space-y-1">
          ...
          <li className ="text-gray">
            <span className="font-bold text-gray">Fold and serve</span>: As the
        ...
        <table class="w-full ">
          <tbody>
            <tr>
              ...
              <td class="px-4 py-2 border-b border-gray font-bold text-Amber">277kcal</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-b text-gray">Carbs</td>
              <td class="px-4 py-2 border-b border-gray font-bold text-Amber">0g</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-b text-gray">Protein</td>
              <td class="px-4 py-2 border-b border-gray font-bold text-Amber">20g</td>
            </tr>
            <tr>
              <td class="px-4 py-2 border-b text-gray">Fat</td>
              <td class="px-4 py-2 border-b border-gray font-bold text-Amber">22g</td>
            </tr>
          </tbody>
        </table>
      </div>
